...
class Wpzoom_Instagram_Widget_API {
    ...
    public function get_items( $image_limit, $image_width ) {
        ...
        if ( is_wp_error( $response ) || 200 != wp_remote_retrieve_response_code( $response ) ) {
            set_site_transient( $transient, false, MINUTE_IN_SECONDS );
        ...
        set_site_transient( $transient, $result, 30 * MINUTE_IN_SECONDS );
    ...
    public function is_configured() {
        ...
        if ( false !== ( $result = get_site_transient( $transient ) ) ) {
            if ( 'yes' === $result ) {
                return true;
            }
        ...
        if ( true === $condition ) {
            set_site_transient( $transient, 'yes', DAY_IN_SECONDS );

            return true;
        }

        set_site_transient( $transient, 'no', DAY_IN_SECONDS );
