...
class WPZOOM_Theme_Setup
{
    ...
    public function get_front_page_content()
    {
        ...
        if ( $front_page_type == 'latest_posts' && ($front_page_option == 'posts' || $front_page_option == 'page') ) {
            $out .= '<p class="description nofloat text-left">'. __('<strong>This theme works best with Latest posts on front page!</strong> If you want to use custom page template for front page, select <strong>A static page</strong> option below and then select the <strong>"Homepage"</strong> and <strong>"Blog"</strong> pages from the lists below.', 'wpzoom') .'</p>';
        }

        if ( $front_page_type == 'static_page' && $front_page_option == 'posts' ) {
            $out .= '<p class="description nofloat text-left">'. __('Your website currently displays <strong>Latest blog posts</strong> on the front page, but this theme works best when you set a <strong>Static Page</strong> with a special page template as your front page.<br/> We recommend you to select <strong>A static page</strong> option below and then select the <strong>"Homepage"</strong> and <strong>"Blog"</strong> pages from the lists below.', 'wpzoom') .'</p>';
        }

        if ( $front_page_type == 'static_page' && $front_page_option == 'page' ) {
            $out .= '<p class="description nofloat text-left">'. __('We recommend you to select <strong>A static page</strong> option below and then select the <strong>"Homepage"</strong> and <strong>"Blog"</strong> pages from the lists below.', 'wpzoom') .'</p>';
        }
