...
class WPZOOM_Theme_Updater {
    ...
    public static function notification() {
        $update_url = isset(WPZOOM::$config['tf_url']) ? WPZOOM::$config['tf_url'] : 'https://wpzoom.com/themes/' . WPZOOM::$theme_raw_name;
        ...
        $tutorial_link = true ? __(' or visit our tutorial on <u><a target="_blank" href="https://www.wpzoom.com/tutorial/how-to-update-a-wpzoom-theme/">updating themes</a></u>.', 'wpzoom') : '';
