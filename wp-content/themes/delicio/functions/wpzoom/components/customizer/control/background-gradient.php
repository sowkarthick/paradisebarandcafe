...
class WPZOOM_Customizer_Control_Background_Gradient extends WP_Customize_Control {
	...
	public function content_template() { ?>
		...
		<div class="zoom-background-gradient-container">
			<strong>{{{ data.translation[ 'start_color' ] }}}</strong>
			<label>
				<span class="screen-reader-text">{{{ data.translation[ 'start_color' ] }}}</span>
				<input id="start_color" class="color-picker-hex" type="text" maxlength="7" placeholder="{{ defaultValue[ 'start_color' ] }}" {{ defaultValueAttr[ 'start_color' ] }} />
			</label>

			<strong>{{{ data.translation[ 'end_color' ] }}}</strong>
			<label>
				<span class="screen-reader-text">{{{ data.translation[ 'end_color' ] }}}</span>
				<input id="end_color" class="color-picker-hex" type="text" maxlength="7" placeholder="{{ defaultValue[ 'end_color' ] }}" {{ defaultValueAttr[ 'end_color' ] }} />
			</label>

			<label>
				<strong>{{{ data.translation[ 'direction' ] }}}</strong>
				<select name="_customize-bg-gradient-directions" id="directions">
			...
			<strong>{{{ data.translation[ 'start_opacity' ] }}}</strong>
			...
			<strong>{{{ data.translation[ 'end_opacity' ] }}}</strong>
			...
			<strong>{{{ data.translation[ 'start_location' ] }}}</strong>
			...
			<strong>{{{ data.translation[ 'end_location' ] }}}</strong>
