...
if ( ! class_exists( 'delicio_CSS' ) ) :
    ...
    class delicio_CSS {
        ...
        /**
         * The one instance of delicio_CSS.
         *
         * @var   delicio_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one delicio_CSS instance.
         *
         * @return delicio_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'delicio_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `delicio_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'delicio_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'delicio_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'delicio_get_css' ) ) :
    /**
     * Return the one delicio_CSS object.
     *
     * @return delicio_CSS    The one delicio_CSS object.
     */
    function delicio_get_css() {
        return delicio_CSS::instance();
    }
endif;

add_action( 'init', 'delicio_get_css', 1 );